    ...
    <section className="hero-section container">
      <div className="hero-left">
        ...
        <h1 className="hero-title-stack">
          <span className="hero-line hero-line-1">INTERNET KI</span>
          <span className="hero-line hero-line-2">SABSE DENK</span>
          <span className="hero-line hero-line-3">JOKE SITE 💀</span>
        </h1>
        <p className="hero-copy">
          Delhi ki 2 AM chai stall energy. Raw. Unhinged. Legendary.
          <br />
          Teri mummy ko bhej — woh block kar degi, tu viral ho jayega.
        </p>
        <div className="hero-seen-row">
          ...
          <span className="hero-seen-chip">💬 Papa Ka Phone</span>
